...
P-values are not meant to be reproducible across studies
    ([Greenland 2016](https://doi.org/10.1007/s10654-016-0149-3), 16th
    and 17th common misinterpretations of P value comparisons) as,
    among other things, they depend on the sample size (which
    typically greatly differ between studies). Comparing estimates and
    confidence intervals is often more reasonable.
