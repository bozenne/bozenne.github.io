...
\label{sec:org2fbc333}

\subsection{Set the working directory}
\label{sec:orgd1bde30}
...
\label{sec:orgac9e60a}
\subsection{Categorize age into groups}
\label{sec:orgd91497b}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\label{sec:orgd268c2c}
\subsection{Introduction}
\label{sec:org1021ddc}
...
\label{sec:org01090f9}
\subsubsection{Number of rows and columns}
\label{sec:org5c2d9d1}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
dim(dtW.data)
\end{lstlisting}
...
\label{sec:orge5fb48e}
\subsubsection{Univariate melt}
\label{sec:org9167cae}
...
\label{sec:org59d5abc}

\subsubsection{Univariate}
\label{sec:orgb8e1c76}
Data in the long format:
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
head(dtL.data)
...
\label{sec:org6299098}

\subsection{Descriptive plots}
\label{sec:org33f8de1}
...
\begin{center}
\includegraphics[width=.9\linewidth]{./figures/fig-pathDiagram1.pdf}
\end{center}
...
\section{Modeling}
\label{sec:org4e3ebd0}
\subsection{Testing linear hypotheses}
\label{sec:orga5a1d3f}
...
\label{sec:orgcb9f61d}
\subsection{Apply with progress bar}
\label{sec:org00cb1cc}
...
\label{sec:orgc42d2d4}
\subsubsection{Detect the number of cores}
\label{sec:org0cd819c}
