...
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
rbind(rmcorr = quantile(dt.res[method=="rmcorr",estimate]),
      lmer = quantile(dt.res[method=="lmer",estimate]))
\end{lstlisting}

\begin{verbatim}
                0%       25%       50%       75%      100%
rmcorr 0.001331043 0.4887141 0.6207839 0.7273354 0.8670439
lmer   0.732343195 0.7738880 0.7900921 0.8094797 0.8472541
\end{verbatim}

\section{Reference}
\label{sec:orgfe2e07b}
\begingroup
