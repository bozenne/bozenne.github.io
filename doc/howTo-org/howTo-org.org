...
#+LaTeX: \setbeamercolor{itemize item}{fg=red}
#+LaTeX:  \setbeamertemplate{itemize item}[square]

#+LaTeX: \setbeamertemplate{itemize subitem}[circle]
#+LaTeX: \setbeamertemplate{itemize subsubitem}[triangle]
...
*** Locally adjust
#+LATEX_HEADER: \usepackage{changepage} %% ## \begin{adjustwidth} ## \end{adjustwidth}
...
#+LaTeX_HEADER: \usepackage{booktabs} % pretty table
#+LaTeX_HEADER: \RequirePackage{diagbox} % diagonally divide table
...
#+LATEX_HEADER: \newcommand{\fourth}{4\textsuperscript{th} }
