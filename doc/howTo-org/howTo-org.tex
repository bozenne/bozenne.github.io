...
\section{Box}
\label{sec:org317d28b}

\begin{frame}[label={sec:org44d8019}]{Round box}
...
\section{Code}
\label{sec:orgc41385f}

\begin{frame}[fragile,label={sec:orgae6774c}]{Set output size}
...
\section{List}
\label{sec:orgf6db71d}

\begin{frame}[label={sec:orga94fe63}]{Choose item}
\begin{description}
\item[{(A)}] yyy
\item[{(1)}] xxx
\end{description}
