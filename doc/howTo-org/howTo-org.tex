...
\maketitle
\section{Box}
\label{sec:org694acca}

\begin{frame}[label={sec:org5f734e0}]{Default block}
\begin{block}{Nested models}
	Consider two models $ \mathcal{M}_0 $ and $ \mathcal{M} $
\end{block}
\end{frame}
\begin{frame}[label={sec:orge4a1340}]{Colored block}
...
\end{frame}
\section{Code}
\label{sec:orgf02287f}

\begin{frame}[label={sec:orgd4625f3},fragile]{Set output size}
...
\end{frame}
\begin{frame}[label={sec:org4bd0da6},fragile]{Inline R}
 Bla \texttt{2}.
\end{frame}
\section{List}
\label{sec:org058d5e3}

\begin{frame}[label={sec:org9b68818}]{Choose item}
\begin{description}
\item[{(A)}] yyy
\item[{(1)}] xxx
\end{description}
\end{frame}
\begin{frame}[label={sec:org4a54774}]{Change color}
...
\end{frame}
\begin{frame}[label={sec:orgfcba8b6}]{Use itemize and modify vertical space}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org7cc5686}]{label scheme}
\begin{itemize}
...
\end{frame}
\section{Table}
\label{sec:orgbac5cb6}
\begin{frame}[label={sec:org3e9b1da}]{Nice latex table}
(require booktabs)
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org953c439},fragile]{From \Rlogo to latex (1/3)}
 \begin{lstlisting}[language=r,numbers=none]
library(xtable)
data(tli)
xtable(tli[1:10, ])
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org4a693f4},fragile]{From \Rlogo to latex (2/2)}
 \begin{lstlisting}[language=r,numbers=none]
library(xtable)
data(tli)
xtable(tli[1:10, ])
...
\end{table}
\end{frame}
\begin{frame}[label={sec:orgbc73ddb},fragile]{From \Rlogo to org}
 \begin{lstlisting}[language=r,numbers=none]
library(ascii)
...
\end{lstlisting}
\end{frame}
\begin{frame}[label={sec:orgcda090a}]{From \Rlogo to latex (3/3)}
\end{frame}
\section{References}
\label{sec:org597184a}

\begin{frame}[label={sec:orgfefd589}]{Citations}
\begin{itemize}
...
\end{frame}
\section{Section}
\label{sec:orgfb5b1b8}
\begin{frame}[label={sec:org76dd2fe}]{No numbering for the section}
\end{frame}
\begin{frame}[label={sec:mysection}]{Reference to the section}
\ref{sec:mysection}
\end{frame}
\section{Minipage}
\label{sec:org6c8f4fe}
\begin{frame}[label={sec:orge305069}]{Align minipage on top}
\begin{minipage}{0.5\linewidth}
\vspace{0pt} # useful if figure or table to set a reference point at the top
xxx
\end{minipage}
...
\label{sec:org3b75cc2}

\begin{frame}[label={sec:org5823cd0}]{Divide the page (align at the middle)}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org6fae928}]{Divide the page (align at the top)}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org8b86a10}]{Inline latex}
any arbitrary LaTeX code
\end{frame}
\begin{frame}[label={sec:orgc27173c}]{Color tex}
(see header for the definition of darkgreen)
\begin{itemize}
\item \textcolor{\darkgreen}{risk factor}: adjust (will increase precision)
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgd678c16}]{Footnote}
This is a footnote\footnote{blaa}.
\end{frame}
\begin{frame}[label={sec:org535451e}]{Big centered text}
\vfill
...
\vfill
\end{frame}
\begin{frame}[label={sec:org887c784}]{Change margin}
(require changepage)
...
\end{adjustwidth}
\end{frame}
\begin{frame}[label={sec:org8880df3}]{strikethrough text}
\sout{help with reproducibility}
\end{frame}
\begin{frame}[label={sec:org7d9e149}]{Trim figure}
\begin{figure}[!h]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orgb70d64b}]{Comments}
\end{frame}
\section{References}
\label{sec:org78a8210}
\begingroup
