...
\begin{frame}[label={sec:orgdb9c9ec}]{Divide the page (align at the top)}
\begin{columns}
...
\begin{frame}[label={sec:org3366087}]{Inline latex}
any arbitrary LaTeX code
\end{frame}

\begin{frame}[label={sec:orgdad6ace}]{Color tex}
