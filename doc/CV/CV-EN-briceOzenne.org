...
\multicolumn{3}{l}{Advice and guidance to neuroscientists medical doctors and psychologists} \\
\multicolumn{3}{l}{(study design, data visualization and analysis, interpretation of the results, scientific writing)} \\ [3mm]
\end{tabular}
#+END_EXPORT
