...
- *LMMstar* (author and maintainer) : linear mixed model via
  ...
  multiple comparisons adjustment. Disponible sur le [[https://cran.r-project.org/web/packages/LMMstar/index.html][CRAN]] et sur
  [[https://github.com/bozenne/LMMstar][Github]]. .
