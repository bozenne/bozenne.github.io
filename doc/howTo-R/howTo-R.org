...
Install
#+BEGIN_SRC R :exports both :results output :session *R* :cache no
devtools::install_github("tagteam/riskRegression") ## v1
install.packages("riskRegression", ## v2
                 lib = "C:/Users/hpl802/Downloads/LIBRTEMPO")
#+END_SRC

Load 
#+BEGIN_SRC R :exports both :results output :session *R* :cache no
library(riskRegression) ## v1
detach("package:riskRegression", unload = TRUE)
library(riskRegression, lib.loc="C:/Users/hpl802/Downloads/LIBRTEMPO") ## v2
detach("package:riskRegression", unload = TRUE)
#+END_SRC
