...
\label{sec:orgbbcd270}
\subsection{Set the working directory}
\label{sec:org90719e7}
...
\label{sec:org1b7fdc5}
\subsection{Categorize age into groups}
\label{sec:orgc77a18f}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\label{sec:org033edb2}
\subsection{Introduction}
\label{sec:orgdbe0601}
...
\label{sec:org52218b2}
\subsubsection{Number of rows and columns}
\label{sec:org483663c}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
dim(dtW.data)
\end{lstlisting}
...
\label{sec:org92d4ad8}
\subsubsection{Univariate melt}
\label{sec:org48fe6f7}
...
\label{sec:org78278cb}

\subsubsection{Univariate}
\label{sec:orgef820f4}
Data in the long format:
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
head(dtL.data)
...
\label{sec:org0189d25}
\subsection{Descriptive plots}
\label{sec:orgf482679}
...
\label{sec:org60663e0}
\clearpage

\subsection{Path diagram}
\label{sec:orge1046bf}
Using lava:
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\section{Modeling}
\label{sec:orgdb6e4c6}
\subsection{Test proportions}
\label{sec:org65bdf83}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\label{sec:org6e930b9}
\subsubsection{Data}
\label{sec:orge51583f}
...
\label{sec:org4fbc98b}
\subsection{Apply with progress bar}
\label{sec:orgad436b3}
...
\label{sec:orgc438b42}
\subsubsection{Detect the number of cores}
\label{sec:orgc7ab4eb}
...
\label{sec:orgaba6cce}
\subsection{Profile code}
\label{sec:org0b85728}
