...
\label{sec:org0b7148d}
\subsection{Set the working directory}
\label{sec:org857af4b}
...
\label{sec:org074b143}
\subsection{Categorize age into groups}
\label{sec:org4110177}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\label{sec:org6be162c}
\subsection{Introduction}
\label{sec:org602febb}
...
\label{sec:org80e6ae4}
\subsubsection{Number of rows and columns}
\label{sec:org10973a0}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
dim(dtW.data)
\end{lstlisting}
...
\label{sec:org6954db3}
\subsubsection{Univariate melt}
\label{sec:orge941a81}
...
\label{sec:org8f033c8}

\subsubsection{Univariate}
\label{sec:org8963d46}
Data in the long format:
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
head(dtL.data)
...
\label{sec:orgf4fb50f}
\subsection{Descriptive plots}
\label{sec:org85f2939}
...
\label{sec:org7e58768}
\clearpage

\subsection{Path diagram}
\label{sec:org7eaace1}
Using lava:
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\section{Modeling}
\label{sec:org93b7675}
\subsection{Test proportions}
\label{sec:org5f96a90}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\label{sec:org3f815b1}
\subsubsection{Data}
\label{sec:org361bdf3}
...
\label{sec:org0f5916f}
\subsection{Apply with progress bar}
\label{sec:org99fc9aa}
...
\label{sec:org322f6cd}
\subsubsection{Detect the number of cores}
\label{sec:orgc4c2bc1}
...
\label{sec:orge2476ef}
\subsection{Profile code}
\label{sec:org33e4d94}
