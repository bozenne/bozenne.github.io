...
\label{sec:org9a0055b}
\subsection{Set the working directory}
\label{sec:orgcaa592c}
...
\label{sec:org7ea6db7}
\subsection{Categorize age into groups}
\label{sec:orgbf46a3f}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\label{sec:orgd6802af}
\subsection{Introduction}
\label{sec:org5a991c4}
...
\label{sec:org65fc704}
\subsubsection{Number of rows and columns}
\label{sec:org213d976}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
dim(dtW.data)
\end{lstlisting}
...
\label{sec:org5798504}
\subsubsection{Univariate melt}
\label{sec:org2b47cbb}
...
\label{sec:org8dbd81d}

\subsubsection{Univariate}
\label{sec:orgd2f7457}
Data in the long format:
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
head(dtL.data)
...
\label{sec:orge7acbb1}
\subsection{Descriptive plots}
\label{sec:org926c35f}
...
\label{sec:orgb823a72}

\subsubsection{Greek letter in facet}
\label{sec:org4f49fa8}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
seqX <- 1:15
...
\section{Modeling}
\label{sec:orgb8879dc}
\subsection{Test proportions}
\label{sec:orgd36e293}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\label{sec:org4330372}
\subsubsection{Data}
\label{sec:org506ac06}
...
\label{sec:org20d47b4}
\subsection{Apply with progress bar}
\label{sec:org7287daa}
...
\label{sec:org64999f6}
\subsubsection{Detect the number of cores}
\label{sec:orga87280e}
...
\label{sec:orgf380e35}
\subsection{Profile code R}
\label{sec:org9a86f12}
...
\#+RESULTS[\textit{<2019-06-27 Thu 09:37> } a0d5077301cabedce939985d9ce7fb7eb9072578]:
