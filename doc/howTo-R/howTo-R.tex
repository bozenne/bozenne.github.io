...
\label{sec:org88cc7c5}
\subsection{Set the working directory}
\label{sec:orgcabf3ac}
...
\label{sec:orge1d4f51}
\subsection{Categorize age into groups}
\label{sec:org24bfd77}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\label{sec:orga0dad99}
\subsection{Introduction}
\label{sec:orge22abbe}
...
\label{sec:orgc698ff7}
\subsubsection{Number of rows and columns}
\label{sec:org383af02}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
dim(dtW.data)
\end{lstlisting}
...
\label{sec:org488633f}
\subsubsection{Univariate melt}
\label{sec:orga70652a}
...
\label{sec:org21d82b6}

\subsubsection{Univariate}
\label{sec:org21fbeac}
Data in the long format:
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
head(dtL.data)
...
\label{sec:org2437098}
\subsection{Descriptive plots}
\label{sec:org86d723a}
...
\label{sec:orgdaa3070}

\subsubsection{Greek letter in facet}
\label{sec:org50edd03}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
seqX <- 1:15
...
\label{sec:org6ac1dbe}
\clearpage

\subsection{Path diagram}
\label{sec:org5a21ebf}
Using lava:
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\section{Modeling}
\label{sec:org74fb075}
\subsection{Test proportions}
\label{sec:org3916431}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\label{sec:org9d5d8d5}
\subsubsection{Data}
\label{sec:orge3d3b4a}
...
\label{sec:orge0f8dbf}
\subsection{Apply with progress bar}
\label{sec:org7ed650f}
...
\label{sec:org82ebc90}
\subsubsection{Detect the number of cores}
\label{sec:org858f558}
...
\label{sec:org21492d8}
\subsection{Profile code}
\label{sec:orga800b36}
