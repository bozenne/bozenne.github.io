...
\label{sec:orge5075d4}
\subsection{Set the working directory}
\label{sec:org4c00ec7}
...
\label{sec:org47dac18}
\subsection{Categorize age into groups}
\label{sec:org8ef4131}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\label{sec:orgf9a0e8d}
\subsection{Introduction}
\label{sec:org615d42c}
...
\label{sec:org3af7ec4}
\subsubsection{Number of rows and columns}
\label{sec:org4dff505}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
dim(dtW.data)
\end{lstlisting}
...
\label{sec:orgc5cd640}
\subsubsection{Univariate melt}
\label{sec:orgbe4dd7d}
...
\label{sec:org9fe5ee4}

\subsubsection{Univariate}
\label{sec:orgc64e7ce}
Data in the long format:
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
head(dtL.data)
...
\label{sec:orga567775}
\subsection{Descriptive plots}
\label{sec:org0ee751d}
...
\label{sec:org021804f}
\clearpage

\subsection{Path diagram}
\label{sec:org49f8090}
Using lava:
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\section{Modeling}
\label{sec:orgf6db203}
\subsection{Test proportions}
\label{sec:org66d2831}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\label{sec:org3ca0ebd}
\subsection{Apply with progress bar}
\label{sec:org9fb9145}
...
\label{sec:orgf00a264}
\subsubsection{Detect the number of cores}
\label{sec:org0e93297}
...
\label{sec:orgdb0f047}
\subsection{Profile code}
\label{sec:org4a58916}
