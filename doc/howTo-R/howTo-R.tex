...
\label{sec:org10cf911}
\subsection{Set the working directory}
\label{sec:org4189667}
...
\label{sec:orgc2bf6a1}
\subsection{Categorize age into groups}
\label{sec:org7bb3b42}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\label{sec:org503f1f7}
\subsection{Introduction}
\label{sec:org7d0c1b5}
...
\label{sec:orgd9454e8}
\subsubsection{Number of rows and columns}
\label{sec:orgc0056f6}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
dim(dtW.data)
\end{lstlisting}
...
\label{sec:orgf2cd6d5}
\subsubsection{Univariate melt}
\label{sec:org9244cf6}
...
\label{sec:org43f2c27}

\subsubsection{Univariate}
\label{sec:orgdcf5876}
Data in the long format:
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
head(dtL.data)
...
\label{sec:org5db2a10}
\subsection{Descriptive plots}
\label{sec:org62ec82a}
...
\label{sec:orgd5e4feb}
\clearpage

\subsection{Path diagram}
\label{sec:orged2f80e}
Using lava:
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\section{Modeling}
\label{sec:org6605f0f}
\subsection{Test proportions}
\label{sec:org11e2296}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\label{sec:org655551c}
\subsection{Apply with progress bar}
\label{sec:org69d8fec}
...
\label{sec:org8a2a6b9}
\subsubsection{Detect the number of cores}
\label{sec:orgd8d0ebe}
...
\label{sec:org3968207}
\subsection{Profile code}
\label{sec:orga18b7ed}
