...
\label{sec:org546a489}
\subsection{Set the working directory}
\label{sec:org72cc9e8}
...
\label{sec:orgad9fe40}
\subsection{Categorize age into groups}
\label{sec:orgea6ca7f}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\label{sec:orgfdde080}
\subsection{Introduction}
\label{sec:org4a9434f}
...
\label{sec:orgb171a77}
\subsubsection{Number of rows and columns}
\label{sec:orgbfa06bd}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
dim(dtW.data)
\end{lstlisting}
...
\label{sec:org623f366}
\subsubsection{Univariate melt}
\label{sec:org24c48e3}
...
\label{sec:org4940761}

\subsubsection{Univariate}
\label{sec:org61e2d9b}
Data in the long format:
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
head(dtL.data)
...
\label{sec:org1c02aba}
\subsection{Descriptive plots}
\label{sec:org81b0906}
...
\label{sec:org12295e3}
\clearpage

\subsection{Path diagram}
\label{sec:org598f2ee}
Using lava:
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\section{Modeling}
\label{sec:orge68f260}
\subsection{Test proportions}
\label{sec:org0fa2b8d}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\label{sec:orgb1f2107}
\subsubsection{Data}
\label{sec:orge7580d0}
...
\label{sec:org2ae491d}
\subsection{Apply with progress bar}
\label{sec:org9cd8ba3}
...
\label{sec:org80576b2}
\subsubsection{Detect the number of cores}
\label{sec:orgb99b4dd}
...
\label{sec:org30ad9b6}
\subsection{Profile code}
\label{sec:org64ae5a4}
