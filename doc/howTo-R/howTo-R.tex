...
\label{sec:org8236ee2}
\subsection{Set the working directory}
\label{sec:org2210bed}
...
\label{sec:orgb594d25}
\subsection{Categorize age into groups}
\label{sec:org09fbe3d}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\label{sec:org942df1c}
\subsection{Introduction}
\label{sec:org9b54cb0}
...
\label{sec:org4715410}
\subsubsection{Number of rows and columns}
\label{sec:orgb875873}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
dim(dtW.data)
\end{lstlisting}
...
\label{sec:org3fc2b30}
\subsubsection{Univariate melt}
\label{sec:orgae85311}
...
\label{sec:org283ba58}

\subsubsection{Univariate}
\label{sec:org7ddac8c}
Data in the long format:
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
head(dtL.data)
...
\label{sec:org474c905}
\subsection{Descriptive plots}
\label{sec:orgeb15155}
...
\label{sec:orgfd32f19}

\subsubsection{Greek letter in facet}
\label{sec:orga53ebd2}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
seqX <- 1:15
...
\subsection{Font}
\label{sec:org0ccfc82}
\subsubsection{Display available fonts}
\label{sec:org3180d40}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
windowsFonts()
\end{lstlisting}
...
\section{Modeling}
\label{sec:org15b6d7d}
\subsection{Test proportions}
\label{sec:orgfe560d9}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\label{sec:org39183a0}
\subsubsection{Data}
\label{sec:org8044e87}
...
\label{sec:org8107fb8}
\subsection{Apply with progress bar}
\label{sec:org6bb99ff}
...
\label{sec:org3d6dc8e}
\subsubsection{Detect the number of cores}
\label{sec:orgf76bf86}
...
\label{sec:org6e5facf}
\subsection{Profile code R}
\label{sec:orga905670}
