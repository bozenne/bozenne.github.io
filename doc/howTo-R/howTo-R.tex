...
\label{sec:org2504262}
\subsection{Set the working directory}
\label{sec:org3c6e14e}
...
\label{sec:org95fb57d}
\subsection{Categorize age into groups}
\label{sec:org7e0710d}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\label{sec:orgdded26b}
\subsection{Introduction}
\label{sec:org62c0d9d}
...
\label{sec:org6cc607e}
\subsubsection{Number of rows and columns}
\label{sec:org8cfbee8}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
dim(dtW.data)
\end{lstlisting}
...
\label{sec:orgda3b11e}
\subsubsection{Univariate melt}
\label{sec:orgb8059c1}
...
\label{sec:org38c78c6}

\subsubsection{Univariate}
\label{sec:org0d0c209}
Data in the long format:
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
head(dtL.data)
...
\label{sec:orgdac1421}
\subsection{Descriptive plots}
\label{sec:org08e169b}
...
\label{sec:orgf1048d4}
\clearpage

\subsection{Path diagram}
\label{sec:orga6fa30c}
Using lava:
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\section{Modeling}
\label{sec:org5aa579f}
\subsection{Test proportions}
\label{sec:org8a67c60}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\label{sec:orgc8c54c2}
\subsubsection{Data}
\label{sec:orgf136ff0}
...
\label{sec:org287b558}
\subsection{Apply with progress bar}
\label{sec:orga9e349e}
...
\label{sec:orgc678355}
\subsubsection{Detect the number of cores}
\label{sec:org5a32206}
...
\label{sec:orgb1fc4ff}
\subsection{Profile code}
\label{sec:org1a07ff4}
